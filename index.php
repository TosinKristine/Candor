        ...
        <div class="container pos-vertical-center">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2>
                        Candor helps businesses like yours
                        <br /> to achieve long-term success.
                    </h2>
                    <p>
                        Future-focussed business strategy and financial management by
                        <strong>Candor</strong>
                    </p>
                    <a href="contact-book-consultation.php" class="btn btn--white btn--unfilled">
                        <span class="btn__text">
                            Book A Consultation
                        </span>
                        <i class="ion-arrow-right-c"></i>
                    </a>
                    <a href="services.php" class="btn btn--white btn--transparent">
                        <span class="btn__text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-push-6 col-sm-8 col-sm-push-2">
                    <h3>
                        Working with Nigerian
                        <br class="hidden-xs" /> businesses for over 20 years
                    </h3>
                    <p>
    ...
    <section class="section-snippet-case-studies" data-tooltip="Case Studies">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="lead">
                        We've helped over 350 businesses to better manage their
