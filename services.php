...
<?php include "includes/nav-colored.php" ?>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="hover-element service-element hover--active">
                                <div class="hover-element__initial">
                                    ...
                                    <p>
                                    We support our customers’ business by sourcing, interviewing and selecting suitable candidates. 
                        ...
                        <div class="col-sm-6">
                            <div class="hover-element service-element hover--active">
                                <div class="hover-element__initial">
                                    ...
                                    <p>
                                    Training isn’t to make employees feel good, have fun and not change or improve! 
                        ...
                        <div class="col-sm-6">
                            <div class="hover-element service-element hover--active">
                                ...
                                <div class="hover-element__reveal" data-overlay="7">
                                    <div class="background-image-holder">
                                        <img alt="image" src="img/service3.jpg" />
                                    </div>
                                </div>
                            </div>
                            <!--end of service-->
                        ...
                        <div class="col-sm-6">
                            <div class="hover-element service-element hover--active">
                                ...
                                <div class="hover-element__reveal" data-overlay="7">
                                    <div class="background-image-holder">
                                        <img alt="image" src="img/service4.jpg" />
                                    </div>
                                </div>
                            </div>
                            <!--end of service-->
                        ...
                        <div class="col-sm-6">
                            <div class="hover-element service-element hover--active">
                                ...
                                <div class="hover-element__reveal" data-overlay="7">
                                    <div class="background-image-holder">
                                        <img alt="image" src="img/service5.jpg" />
                                    </div>
                                </div>
                            </div>
                            <!--end of service-->
                        ...
                        <div class="col-sm-6">
                            <div class="hover-element service-element hover--active">
                                ...
                                <div class="hover-element__reveal" data-overlay="7">
                                    <div class="background-image-holder">
                                        <img alt="image" src="img/service6.jpg" />
                                    </div>
                                </div>
                            </div>
                            <!--end of service-->
